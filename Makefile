...
CXXFLAGS=-c -std=c++11 -Wall -O2 -I../include -I./util -I/usr/local/Cellar/openssl@1.1/1.1.1g/include
LDFLAGS=-O2 -L/usr/local/Cellar/openssl@1.1/1.1.1g/lib -lssl -lcrypto
ifeq ($(platform),haiku)
LDFLAGS+=-lnetwork -L/usr/local/Cellar/openssl@1.1/1.1.1g/lib -llibssl
endif
